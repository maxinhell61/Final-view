...
def register():
    ...
    new_user = User(name=name, email=email, phone=phone, 
                    password=hashed_password, role=role, isActive = True)
...
def register_admin():
    ...
    hashed_password = generate_password_hash(password)
    new_admin = User(name=name, email=email, phone=phone, 
...
def login():
    ...
    if not user.isActive:
        return jsonify({"error":"user is banned, please contact the administrator"})
